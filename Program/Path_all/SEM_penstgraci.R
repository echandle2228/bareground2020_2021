#' # Path analysis for phenology project: Penstemon gracilis
...
#' Load Data
penst.graci <- read.csv( file = "Data/penst.graci.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=penst.graci, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/SEM_penstgraci.R", out_dir = "Output", keep_rmd = F, keep_md = F)
