#' # Path analysis for phenology project: Vicia americana
...
#' Load Data
vicia.ameri <- read.csv( file = "Data/vicia.ameri.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=vicia.ameri, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/SEM_viciaameri.R", out_dir = "Output", keep_rmd = F, keep_md = F)
