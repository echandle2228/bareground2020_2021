#' # Path analysis for phenology project: Zigadenus elegans
...
#' Load Data
zigad.elaga <- read.csv( file = "Data/zigad.elaga.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=zigad.elaga, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/SEM_zigadelaga.R", out_dir = "Output", keep_rmd = F, keep_md = F)
