#' # Path analysis for phenology project: Trillium cernuum
...
#' Load Data
trill.cernu <- read.csv( file = "Data/trill.cernu.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=trill.cernu, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/path_noDOBG/SEM_trillcernu_test1.R", out_dir = "Output", keep_rmd = F, keep_md = F)
