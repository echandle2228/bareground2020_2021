#' # Path analysis for phenology project: Ranunculus abortivus
...
#' Load Data
ranun.arbor <- read.csv( file = "Data/ranun.arbor.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=ranun.arbor, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/path_noDOBG/SEM_ranunarbor_test1.R", out_dir = "Output", keep_rmd = F, keep_md = F)
