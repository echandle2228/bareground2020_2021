#' # Path analysis for phenology project: Lithospermum incisum
...
#' Load Data
litho.incis <- read.csv( file = "Data/litho.incis.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=litho.incis, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/path_noDOBG/SEM_lithoincis_test1.R", out_dir = "Output", keep_rmd = F, keep_md = F)
