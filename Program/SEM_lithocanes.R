#' # Path analysis for phenology project: Lithospermum canescens
...
#' Load Data
litho.canes <- read.csv( file = "Data/litho.canes.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=litho.canes, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/SEM_lithocanes.R", out_dir = "Output", keep_rmd = F, keep_md = F)
