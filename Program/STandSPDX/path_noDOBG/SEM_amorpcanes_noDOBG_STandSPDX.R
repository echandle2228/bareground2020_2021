...
#' Load Data
amorp.canes <- read.csv( file = "Data/amorp.canes.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=amorp.canes, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/STandSPDX/path_noDOBG/SEM_amorpcanes_noDOBG_STandSPDX.R", out_dir = "Output", keep_rmd = F, keep_md = F)
