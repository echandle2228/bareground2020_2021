#' # Path analysis for phenology project: Sisyrinchium angustifolium
...
#' Load Data
sisy.angus <- read.csv( file = "Data/sisy.angus.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=sisy.angus, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/SEM_sisyangus.R", out_dir = "Output", keep_rmd = F, keep_md = F)
