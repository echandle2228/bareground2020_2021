#' # Path analysis for phenology project: Pedicularis canadensis
...
#' Load Data
pedic.canad <- read.csv( file = "Data/pedic.canad.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=pedic.canad, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/SEM_pediccanad.R", out_dir = "Output", keep_rmd = F, keep_md = F)
