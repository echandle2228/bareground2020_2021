#' # Path analysis for phenology project: Oxalis violacea
...
#' Load Data
oxali.viola <- read.csv( file = "Data/oxali.viola.csv", 
...
#' ### Lavaan function
fit<-lavaan(model,data=oxali.viola, missing = "fiml")
...
# ezknitr::ezspin(file = "Program/SEM_oxaliviola.R", out_dir = "Output", keep_rmd = F, keep_md = F)
